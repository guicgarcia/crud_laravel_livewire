        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="cell_phone" type="text" class="form-control" id="cell_phone" placeholder="Cell Phone">@error('cell_phone') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
